      ...
      >
        <div className="space-y-4">
          <motion.div
            ...
            className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-4xl font-bold"
          >
            NK
          </motion.div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            I am a UC Davis student interested in the world of data engineering and product management.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-gray-600 dark:text-gray-300">Bachelor's Degree in Computer Science</p>
                <p className="text-gray-600 dark:text-gray-300">Expected Graduation: 2025</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Python, Java, JavaScript, SQL</p>
                </div>
                <div>
                  <p className="font-semibold mb-2">Technologies:</p>
                  <p className="text-gray-600 dark:text-gray-300">Apache Spark, Kafka, Docker, AWS</p>
                </div>
                <div>
